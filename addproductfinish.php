...
?><span class="caret"></span></a>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
      ...
      <form role="search" action="dashresults.php" method="GET">
		...
		<ul class="nav menu">
            ...
            <li><a href="addproduct.php"><svg class="glyph stroked star"><use xlink:href="#stroked-star"/></svg>
            </svg> Add Brand </a></li>
  ...
  <a href="addproduct.php" class="btn btn-primary btn-lg active" role="button" aria-pressed="true"> Add another product </a>
